...
# ===========================================================================
HOST = "exi-0"   # shown as  exi-0@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Associate AI Engineer @ E-Solutions Inc."),
    ("kv", "Prev", "AI Intern @ Adeptia & Edujoy"),
    ("kv", "Edu", "B.Tech ECE, JIIT Noida '26"),
    ("gap",),
    ("sec", "AI / ML & Data Science"),
    ("kv", "Agents", "LangGraph, LangChain, Multi-Agent"),
    ("kv", "GenAI", "LLMs, RAG, OpenAI, Gemini APIs"),
    ("kv", "CV & ASR", "Grounding DINO, YOLOv8, NeMo, Pyannote"),
    ("kv", "Vector", "Pinecone, SentenceTransformers"),
    ("gap",),
    ("sec", "Skills"),
    ("kv", "Lang", "Python, C++, SQL, OOPs"),
    ("kv", "Web", "HTML, CSS, NumPy, Matplotlib"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Built automated data mapping & ASR pipelines"),
    ("bul", "Developed RAG HR Assistant & Auto-Annotation"),
]
